...
import com.kodetr.gamehagon.sonic.SonicRuntimeImpl;
import com.kodetr.gamehagon.sonic.SonicSessionClientImpl;
...
public class HagonActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String url = getIntent().getStringExtra("gameurl");
...
//            if (MainActivity.MODE_SONIC_WITH_OFFLINE_CACHE == mode) {
        ...
        sessionConfigBuilder.setConnectionInterceptor(new SonicSessionConnectionInterceptor() {
            ...
            public SonicSessionConnection getConnection(SonicSession session, Intent intent) {
                return new OfflinePkgSessionConnection(HagonActivity.this, session, intent);
            }
        });
        ...
        setContentView(R.layout.activity_hagon);
